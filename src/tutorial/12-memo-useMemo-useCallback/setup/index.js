...
const Index = () => {
  ...
  const mostExpensive = useMemo(() => calcutelExpensive(products), [
    products,
  ])
  return (
    <>
      ...
      <h1>Expensive Item :${mostExpensive}</h1>
...
const SingleProduct = ({ fields,  addCart }) => {
  console.log('single List ave 6e ');
